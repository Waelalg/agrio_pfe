...
\vspace{0.25cm}
{\large In partial fulfillment of the requirements for the Master's degree\par}
\vspace{0.18cm}
{\large Field: \textbf{Computer Science}\par}
\vspace{0.18cm}
{\large Specialty: \textbf{Ingénierie des Systèmes Informatiques \& Intelligence Artificielle et Science de Données }\par}
