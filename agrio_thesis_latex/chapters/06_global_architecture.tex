...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/chapter_06/Figure 6.1 — Global overview of the Agrio Digital Twin smart irrigation architecture.png}
...
\section{Physical prototype layer}
...
\section{Radio-frequency and gateway layer}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/chapter_06/Figure 6.2 — Physical and communication architecture of the controlled smart irrigation prototype.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/chapter_06/Figure 6.3 — MQTT topic architecture for sensor ingestion, actuator commands, and WeMos status feedback.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/chapter_06/Figure 6.4 — Internal backend architecture of the FastAPI-based Digital Twin platform.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/chapter_06/Figure 6.5 — Digital Twin processing architecture from live sensor data to simulation and recommendation.png}
...
\section{Recommendation and validation layer}
...
\section{Actuator and feedback layer}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/chapter_06/Figure 6.6 — Docker Compose deployment architecture of the Agrio platform.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/chapter_06/Figure 6.7 — Detailed technical architecture of the implemented Digital Twin smart irrigation platform.png}
