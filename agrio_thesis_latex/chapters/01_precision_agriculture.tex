...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.9\textwidth]{figures/chapter_01/fig_1-1_conceptual-scope-of-precision-agriculture-and.png}
    \fbox{\parbox{0.85\textwidth}{\centering Insert Figure 1.1 here: Conceptual scope of precision agriculture and smart irrigation.}}
...
\section{1.2 Water scarcity and irrigation management}
...
\section{1.3 From conventional irrigation to smart irrigation}
...
\section{1.4 Main variables in smart irrigation}
...
\section{1.5 Communication technologies in smart irrigation}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.9\textwidth]{figures/chapter_01/fig_1-2_generic-communication-chain-for-iot-based-sma.png}
    \fbox{\parbox{0.85\textwidth}{\centering Insert Figure 1.2 here: Generic communication chain for IoT-based smart irrigation.}}
...
\section{1.6 Actuators and irrigation control}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.9\textwidth]{figures/chapter_01/fig_1-3_pump-control-concept-using-wemos-relay-and-mq.png}
    \fbox{\parbox{0.85\textwidth}{\centering Insert Figure 1.3 here: Pump control concept using WeMos, relay, and MQTT command/status topics.}}
...
\section{1.7 Challenges of smart irrigation systems}
